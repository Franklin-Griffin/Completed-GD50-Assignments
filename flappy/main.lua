...
function love.update(dt)
    ...
    -- do not scroll/update during pause
    if not pause then
...
function love.draw()
    ...
    -- draw pause button
    if pause then
        -- draw at 1% scale (my image is large) at the center of the screen
        love.graphics.draw(pauseIcon, VIRTUAL_WIDTH / 2 - pauseIcon:getWidth() / 20, VIRTUAL_HEIGHT / 2 - pauseIcon:getHeight() / 20, 0, 0.1, 0.1)
    end
