...
function GenerateQuads(atlas, tilewidth, tileheight, ix, iy, countX, countY)
    ...
    for y = iy or 0, (countY or sheetHeight) - 1 + (iy or 0) do
        for x = ix or 0, (countX or sheetWidth) - 1 + (ix or 0) do
